...
trait RevisionableTrait
{
    ...
    public static function _revisionableBoot()
    {
    ...
    {
        return $this->morphMany('Cms\Site\Revisions\Revision', 'revisionable');
    }
...
//            );
//            $revision = new \Cms\Site\Revisions\Revision;
