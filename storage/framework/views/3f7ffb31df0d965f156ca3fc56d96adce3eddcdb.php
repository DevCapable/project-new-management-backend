<form class="" method="post" action="<?php echo e(route('admin-client-update-project-review',[$currentWorkspace->slug,$project->project_id])); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <select id="status" name="status" class="form-control select2">
                ...
                <option value="NotSubmitted" <?php if($project->status == 'NotSubmitted'): ?> selected <?php endif; ?>><?php echo e(__('NotSubmitted')); ?></option>
                <option value="UnderReview" <?php if($project->status == 'UnderReview'): ?> selected <?php endif; ?>><?php echo e(__('UnderReview')); ?></option>
                <option value="Processing" <?php if($project->status == 'Processing'): ?> selected <?php endif; ?>><?php echo e(__('Processing')); ?></option>
                <option value="Finished" <?php if($project->status == 'Finished'): ?> selected <?php endif; ?>><?php echo e(__('Finished')); ?></option>
                <option value="PENDING" <?php if($project->status == 'PENDING'): ?> selected <?php endif; ?>><?php echo e(__('PENDING')); ?></option>
        ...
        <div class="form-group " style="background-color:limegreen; padding: 5px; border-radius: 10px; font-weight: bold">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="hidden" id="project_id" name="project_id" value="<?php echo e($project->project_id); ?>">
...
<?php /**PATH /home/heritage/SHINE/LATEST/projectmanagement/resources/views/admin/clients/review/_review_project.blade.php ENDPATH**/ ?>