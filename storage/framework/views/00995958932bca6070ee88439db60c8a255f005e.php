...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <input type="hidden" name="metadata"
                                               value="<?php if(isset($client->email)): ?><?php echo e(json_encode($array = ['email' => $client->email, 'user_id'=>$client->id])); ?><?php endif; ?>">
                                        ...
                                        <div class="card">
                                            <div class="card-shadow">
                                                ...
                                                <div class="card-body">
                                                    <p>
                                                        <?php if($client->payment_policy === NULL): ?>
                                ...
                                <p class="mb-2 mt-2 ">Already have an account? <a href="<?php echo e(route('login', $lang)); ?>"
                                                                                  class="f-w-400 text-primary"><?php echo e(__('Sign In')); ?></a>
                                </p>
...
<script>
    ...
    function makePayment(amount, currency, email, name) {
        FlutterwaveCheckout({
            ...
            redirect_url: "<?php echo e(\Illuminate\Support\Facades\URL::to('/client/login')); ?>",
            meta: {
            ...
            callback: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('payWithFlutter')); ?>",
                    data: {
                        data,
                        _token
                    },
...
<?php /**PATH /home/heritage/SHINE/LATEST/projectmanagement/resources/views/auth/_client_reg_payment.blade.php ENDPATH**/ ?>