    ...
    <div class="row  display-none" id="show_filter">
        ...
        <div class="col-3">
            <select class="select2 form-select" name="status" id="status">
                ...
                <option value="OnRequest">{{ __('OnRequest')}}</option>
...
{{--                                @endif--}}
                        ...
                        <div>
                            <a style="float: right; font-size: 40px; padding-right: 10px" href="{{route('client.calender.index',$currentWorkspace->slug)}}"
        ...
        <script>
            $(document).ready(function() {
                ...
                function getData() {
                    ...
                    $.ajax({
                        url: '{{ route('appointment-ajax', [$currentWorkspace->slug]) }}',
                        type: 'POST',
                        data: data,
