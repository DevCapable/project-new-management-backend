                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom:40px;">
                                <form id="makePaymentForm" method="POST" action="{{ route('pay') }}"
                                    ...
                                    <div class="col-md-12 col-md-offset-4">
                                        ...
                                        <input type="hidden" name="metadata"
                                               value="@if(isset($client->email)){{ json_encode($array = ['email' => $client->email, 'user_id'=>$client->id,'payment_type'=>'appointment']) }}@endif">
                                ...
                                <p class="mb-2 mt-2 ">ill do this latter <a href="/client"
                                                                                  class="f-w-400 text-primary">{{ __('Dashboard') }}</a>
                                </p>
...
<script>
    ...
    function makePayment(amount, currency, email, name) {
        FlutterwaveCheckout({
            ...
            redirect_url: "{{\Illuminate\Support\Facades\URL::to('/client')}}",
            meta: {
            ...
            callback: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('appointment-pay-with-flutter')}}",
                    data: {
                        data,
                        _token
                    },
