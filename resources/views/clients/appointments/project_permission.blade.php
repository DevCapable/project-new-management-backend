 ...
 <div class="modal-body">
    ...
    <tr>
        ...
        <td>
            <div class="row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission7" @if(in_array('create task',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="create task">
    ...
    <tr>
        ...
        <td>
            <div class="row cust-checkbox-row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission17" @if(in_array('create bug report',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="create bug report">
                    <label for="permission17" class="custom-control-label">{{__('Create')}}</label><br>
                </div>
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission18" @if(in_array('edit bug report',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="edit bug report">
                    <label for="permission18" class="custom-control-label">{{__('Edit')}}</label><br>
                </div>
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission19" @if(in_array('delete bug report',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="delete bug report">
                    <label for="permission19" class="custom-control-label">{{__('Delete')}}</label><br>
                </div>
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission20" @if(in_array('show bug report',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show bug report">
                    <label for="permission20" class="custom-control-label">{{__('Show')}}</label><br>
                </div>
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission21" @if(in_array('move bug report',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="move bug report">
    ...
    <tr>
        ...
        <td>
            <div class="row cust-checkbox-row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission1" @if(in_array('show activity',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show activity">
    ...
    <tr>
        ...
        <td>
            <div class="row cust-checkbox-row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission16" @if(in_array('show timesheet',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show timesheet">
    ...
    <tr>
        ...
        <td>
            <div class="row cust-checkbox-row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission22" @if(in_array('show gantt',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show gantt">
    ...
    <tr>
        ...
        <td>
            <div class="row cust-checkbox-row">
                <div class="form-check form-switch d-inline-block col">
                    <input class="form-check-input" id="permission15" @if(in_array('show uploading',$permissions)) checked="checked" @endif name="permissions[]" type="checkbox" value="show uploading">
