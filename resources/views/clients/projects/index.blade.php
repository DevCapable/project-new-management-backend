...
@section('action-button')
    @auth('web')
            ...
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Project') }}" data-url="{{route('projects.create',$currentWorkspace->slug)}}" data-toggle="tooltip" title="{{ __('Create') }}">
    ...
    @auth('client')
        ...
        @if(isset($currentWorkspace) || $currentWorkspace->creater->id == Auth::id())
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Project') }}" data-url="{{route('create-new-client-projects',$currentWorkspace->slug)}}" data-toggle="tooltip" title="{{ __('Create') }}">
                <i class="ti ti-plus"></i>
            </a>
        @endif
    @endauth
                      ...
                      <div class="col-md-3 All {{ $project->status }}">
                                <div class="card">
                                    ...
                                    @if($project->is_active)
                                        <a href="@auth('web'){{route('projects.show',[$currentWorkspace->slug,$project->id])}}@elseauth{{route('show-client-project',[$currentWorkspace->slug,$project->id])}}@endauth" class="">
                                    ...
                                    @endif
                                            ...
                                            <h5 class="mb-0">
                                             @if($project->is_active)
                                            <a href="@auth('web'){{route('projects.show',[$currentWorkspace->slug,$project->id])}}@elseauth{{route('show-client-project',[$currentWorkspace->slug,$project->id])}}@endauth" title="{{ $project->name }}" class="">{{ $project->name }}</a>
                                            @else
                    ...
                    @endforeach
                          ...
                          @auth('web')
                            @if(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id())
                             <div class="col-md-3 All add_project">
                                <a href="#"  style="padding: 90px 10px;" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Project') }}" data-url="{{route('projects.create',$currentWorkspace->slug)}}">
                        ...
                        @auth('client')
                            @if(isset($currentWorkspace) || $currentWorkspace->clientCreater->id == Auth::id())
                                <div class="col-md-3 All add_project">
                                    <a href="{{route('create-new-client-projects',$currentWorkspace->slug)}}" class="btn-addnew-project " style="padding: 90px 10px;"  data-size="md" data-title="{{ __('Create New Project') }}" data-url="{{route('create-new-client-projects',$currentWorkspace->slug)}}">
                                        <div class="bg-primary proj-add-icon">
                                            <i class="ti ti-plus"></i>
                                        </div>
                                        <h6 class="mt-4 mb-2">Add Project</h6>
