    ...
    <nav class="navbar navbar-expand-md navbar-dark default">
      <div class="container">
        <a class="navbar-brand bg-transparent" href="#">
          <img src="{{asset('assets/logo/logo-dark.png')}}" alt="logo" />
{{--            @include('layouts._company_logo')--}}
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="btn btn-light ms-2 me-1" href="{{ route('register', $lang ='en') }}">Register</a>
            </li>
            @endif
          </ul>
        </div>
        ...
        <div class="row align-items-center justify-content-center mb-5 mobile-screen">
          <div class="col-auto">
            <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
              <img
                src="{{asset(Storage::url('logo/logo-light.png'))}}"
                alt=""
                class="img-fluid"
              />
            </div>
