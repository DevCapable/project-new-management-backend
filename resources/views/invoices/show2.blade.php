                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <input class="form-control currency_input" type="number" id="amount" name="amount" value="{{$invoice->getDueAmount()}}" min="0" step="0.01" max="{{$invoice->getDueAmount()}}" placeholder="{{ __('Enter Monthly Price') }}">
                                        </div>
                                    </div>
                                            ...
                                            <form method="post" action="{{ route('client.invoice.payment',[$currentWorkspace->slug,$invoice->id]) }}" class="require-validation" id="payment-form">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-icon-user">
                                                            <span class="currency-icon bg-primary">{{ (!empty($currentWorkspace->currency)) ? $currentWorkspace->currency : '$'}}</span>
                                                            <input class="form-control currency_input" required="required" min="0" name="amount" type="number" value="{{$invoice->getDueAmount()}}" min="0" step="0.01" max="{{$invoice->getDueAmount()}}" id="amount">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
