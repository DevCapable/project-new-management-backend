                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        <div data-v-f2a183a6="" class="d-header-brand">
                                            <img src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif" style="max-width: 100px"/>
                                        </div>
                                                    ...
                                                    @foreach($items as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{($color == '#ffffff') ? 'black' : $color}};">
                                                            ...
                                                            <div class="d-table-td w-17">
                                                                <pre data-v-f2a183a6="">{{($item->task)?$item->task->title:""}}</pre>
                                                            </div>
