                        ...
                        <div data-v-1ad6e3b9="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                                    ...
                                                    @foreach($items as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-17" style="border: 1px solid {{$color}}; padding: 5px;">
                                                                <pre data-v-1ad6e3b9="">{{($item->task)?$item->task->title:""}}</pre>
                                                            </div>
