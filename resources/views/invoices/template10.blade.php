                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 200px;" class="d-logo" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif"></div>
                                                ...
                                                @foreach($items as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr">
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-17">
                                                            <pre data-v-b8f60a0c="">{{($item->task)?$item->task->title:""}}</pre>
                                                        </div>
