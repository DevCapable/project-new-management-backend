                            ...
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-1">
                                        <img data-v-363339a0="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif" style="max-width: 150px" class="d-logo">
                                    </div>
                                                ...
                                                @foreach($items as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-17">
                                                            <pre data-v-363339a0="">{{($item->task)?$item->task->title:""}}</pre>
                                                        </div>
