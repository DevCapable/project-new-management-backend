                        ...
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    ...
                                    <div data-v-7d9d14b5="" class="col-1"><img data-v-7d9d14b5="" class="d-logo" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif" style="max-width: 150px;"></div>
                                                ...
                                                @foreach($items as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-td w-17" style="padding: 3px;">
                                                            <pre data-v-7d9d14b5="">{{($item->task)?$item->task->title:""}}</pre>
                                                        </div>
