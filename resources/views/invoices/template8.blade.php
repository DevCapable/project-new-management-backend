                            ...
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66">
                                        <img data-v-136bf9b5="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-light.png'))}}@endif" class="d-logo" style="max-width: 200px;">
                                                ...
                                                @foreach($items as $key => $item)
                                                    <div data-v-136bf9b5="" class="d-table-tr">
                                                        ...
                                                        <div data-v-136bf9b5="" class="d-table-td w-17">
                                                            <pre data-v-136bf9b5="">{{($item->task)?$item->task->title:""}}</pre>
                                                        </div>
