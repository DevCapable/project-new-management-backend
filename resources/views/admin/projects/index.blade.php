                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div class="d-flex align-items-center">
                                        @if($project->is_active)
                                            <a href="@auth('web'){{route('admin-show-project',[$currentWorkspace->slug,$project->id])}}@elseauth{{route('admin-show-project',[$currentWorkspace->slug,$project->id])}}@endauth"
                                               class="">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if($project->is_active)
                                                        ...
                                                        <form id="delete-form-{{$project->id}}"
                                                              action="{{ route('admin-projects-destroy',[$currentWorkspace->slug,$project->id]) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="user-group mx-2">
                                        ...
                                        <a href="@auth('web'){{route('admin-show-project',[$currentWorkspace->slug,$project->id])}}@elseauth{{route('admin-show-project',[$currentWorkspace->slug,$project->id])}}@endauth" class="">
                                           class="">
                    ...
                    @auth('client')
                        @if(isset($currentWorkspace) || $currentWorkspace->clientCreater->id == Auth::id())
                            <div class="col-md-3 All add_project">
                                <a href="#" class="btn-addnew-project " style="padding: 90px 10px;"
                                   data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Project') }}"
                                   data-url="{{route('create-new-client-projects',$currentWorkspace->slug)}}">
                                    <div class="bg-primary proj-add-icon">
                                        <i class="ti ti-plus"></i>
                                    </div>
                                    <h6 class="mt-4 mb-2">Add Project</h6>
