...
@section('content')
    ...
    <form class="" method="post" action="{{ route('admin-client-task-store',[$currentWorkspace->slug,$project->project_id]) }}">
        @csrf
        <div>
            <div class="row">

                @include('admin.clients.projects.task._task_form')
            </div>
        </div>
...
@push('scripts')
    ...
    @include('admin.clients.projects.task._add_more_fields_js')
@endpush
