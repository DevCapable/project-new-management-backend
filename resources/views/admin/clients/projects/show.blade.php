...
{{--    @if((isset($permissions)) || (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner'))--}}
...
{{--    @if((isset($permissions)) || (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner'))--}}
{{--        <div class="col-sm-auto  ">--}}
{{--            <a href="{{route('client-projects-task-board',[$currentWorkspace->slug,$project->id])}}"--}}
                                        ...
                                        @if($currentWorkspace || $currentWorkspace->permission == 'Owner')
                                            ...
                                            <div class="d-flex align-items-center ">
                                                <button class="btn btn-light d-flex align-items-between me-3">
                                                    <a href="#" class=""
                                                       data-url="{{ route('admin-client-project-review',[$currentWorkspace->slug,$project->project_id]) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            <div class="timeline timeline-one-side top-10-scroll" data-timeline-content="axis"
                                ...
                                @if((isset($permissions)) || $currentWorkspace->permission == 'Owner')
                                    @foreach($project->activities as $activity)
                                        <div class="timeline-block px-2 pt-3">
                                            ...
                                            @elseif($activity->log_type == 'Assign Task')
                                                <span
                                                    class="timeline-step timeline-step-sm border border-success text-white"> <i
                                                        class="fas fa-tasks"></i></span>
...
{{--                                        @if((isset($permissions) ) || $currentWorkspace->permission == 'Owner')--}}
{{--                                            @auth('web')--}}
{{--                                                <a href="{{route('admin-client-create-new-task',[$currentWorkspace->slug,$project->id])}}"--}}
{{--                                                   class="btn btn-sm btn-primary"--}}
{{--                                                   data-title="{{ __('Create Task') }}"--}}
{{--                                                   title="{{__('Create')}}"><i class="ti ti-plus"></i></a>--}}
{{--                                            @elseauth('client')--}}
{{--                                                <a href="{{route('client-create-new-task',[$currentWorkspace->slug,$project->id])}}"--}}
{{--                                                   class="btn btn-sm btn-primary"--}}
{{--                                                   data-title="{{ __('Create Task') }}"--}}
{{--                                                   title="{{__('Create')}}"><i class="ti ti-plus"></i></a>--}}
{{--                                            @endauth--}}
...
{{--                                    </div>--}}
                                        ...
                                        @foreach($project->tasks() as $key => $task)
                                            <tr>
                                                <td><a href="#" class="d-block font-weight-500 mb-0"
                                                       ...
                                                       data-url="{{route($client_keyword.'projects.milestone.show',[$currentWorkspace->slug,$task->id])}}">
                                                ...
                                                <td class="text-right">
                                                    <div class="col-auto">
                                                                ...
                                                                <a href="#"
                                                                   ...
                                                                   data-ajax-popup="true" data-size="lg"
                                                                   data-toggle="popover" title="{{__('Review')}}"
                                                                   data-title="{{__('Review Task')}}"
                                                                   data-url="{{route('admin-client-tasks-review',[$currentWorkspace->slug,$task->project_id,$task->id,])}}"><i
                                                                        class="ti ti-eye"></i></a>
                                                            ...
                                                            <form id="delete-form1-{{$task->id}}"
                                                                  action="{{ route('client-tasks-destroy',[$currentWorkspace->slug,$task->project_id,$task->id]) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                ...
                @if((isset($permissions)) || $currentWorkspace->permission == 'Owner' || $currentWorkspace->permission == 'Member')
