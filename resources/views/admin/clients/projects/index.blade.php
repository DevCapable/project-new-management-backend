...
@section('action-button')
    @auth('web')
        ...
        @if(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id())
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
               ...
               data-url="{{route('projects.create',$currentWorkspace->slug)}}" data-toggle="tooltip"
               title="{{ __('Create') }}">
    ...
    @auth('client')
        ...
        @if(isset($currentWorkspace) || $currentWorkspace->creater->id == Auth::id())
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
               data-title="{{ __('Create New Project') }}"
               data-url="{{route('create-new-client-projects',$currentWorkspace->slug)}}" data-toggle="tooltip"
               title="{{ __('Create') }}">
                <i class="ti ti-plus"></i>
            </a>
        @endif
                                ...
                                <div class="card-header border-0 pb-0">
                                    <div class="d-flex align-items-center">
                                        @if($project->is_active)
                                            ...
                                            <a href="{{route('admin-client-show-project',[$currentWorkspace->slug,$project->project_id])}}"
                                               class="">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if($project->is_active)
                                                    <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                       ...
                                                       data-url="{{route('admin-client-projects-invite-popup',[$currentWorkspace->slug,$project->project_id])}}">
                                                    ...
                                                    <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                       ...
                                                       data-url="{{route('admin-client-projects-edit',[$currentWorkspace->slug,$project->project_id])}}">
                                                        <i class="ti ti-edit"></i> <span>{{ __('Edit') }}</span>
                                                    </a>
                                                    <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                       data-size="md" data-title="{{ __('Share to Clients') }}"
                                                       data-url="{{route('admin-client-projects-share-popup',[$currentWorkspace->slug,$project->project_id])}}">
                                                    ...
                                                    <form id="delete-form-{{$project->project_id}}"
                                                          action="{{ route('admin-client-projects-destroy',[$currentWorkspace->slug,$project->project_id]) }}"
